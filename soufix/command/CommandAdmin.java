...
public class CommandAdmin extends AdminUser
{
  ...
  public void command(String command, String[] infos, String msg)
  {
    ...
    else if(command.equalsIgnoreCase("GIFTS"))
    {
      ...
      {
        Database.getDynamics().getGiftData().update(player.getAccount().getId(),gifts+";"+gift);
      }
      this.sendMessage(name+" a reeu le cadeau : "+gift+".");
      return;
    }
    ...
    else if(command.equalsIgnoreCase("SETGROUPE"))
    {
      ...
      Database.getStatics().getAccountData().updateBannedTime(perso.getAccount(),System.currentTimeMillis()+86400000*999);
        if(perso.getGameClient()!=null)
          perso.getGameClient().disconnect();
      }
