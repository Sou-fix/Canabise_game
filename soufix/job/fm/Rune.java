...
public class Rune
{
  ...
  public static void addRunes()
  {
    ...
    new Rune(1548,Integer.toHexString(Constant.STATS_ADD_VITA),Integer.toHexString(Constant.STATS_REM_VITA),(byte)15,3f,1.5f); //Pa Vi
    new Rune(1554,Integer.toHexString(Constant.STATS_ADD_VITA),Integer.toHexString(Constant.STATS_REM_VITA),(byte)50,10f,5f); //Ra Vi
    new Rune(1521,Integer.toHexString(Constant.STATS_ADD_SAGE),Integer.toHexString(Constant.STATS_REM_SAGE),(byte)1,3f,2f); //Sa
    new Rune(1546,Integer.toHexString(Constant.STATS_ADD_SAGE),Integer.toHexString(Constant.STATS_REM_SAGE),(byte)3,9f,6f); //Pa Sa
    new Rune(1552,Integer.toHexString(Constant.STATS_ADD_SAGE),Integer.toHexString(Constant.STATS_REM_SAGE),(byte)10,30f,20f); //Ra Sa
    new Rune(1519,Integer.toHexString(Constant.STATS_ADD_FORC),Integer.toHexString(Constant.STATS_REM_FORC),(byte)1,1f,1f); //Fo
    new Rune(1545,Integer.toHexString(Constant.STATS_ADD_FORC),Integer.toHexString(Constant.STATS_REM_FORC),(byte)3,3f,3f); //Pa Fo
    new Rune(1551,Integer.toHexString(Constant.STATS_ADD_FORC),Integer.toHexString(Constant.STATS_REM_FORC),(byte)10,10f,10f); //Ra Fo
    new Rune(1522,Integer.toHexString(Constant.STATS_ADD_INTE),Integer.toHexString(Constant.STATS_REM_INTE),(byte)1,1f,1f); //Ine
    new Rune(1547,Integer.toHexString(Constant.STATS_ADD_INTE),Integer.toHexString(Constant.STATS_REM_INTE),(byte)3,3f,3f); //Pa Ine
    new Rune(1553,Integer.toHexString(Constant.STATS_ADD_INTE),Integer.toHexString(Constant.STATS_REM_INTE),(byte)10,10f,10f); //Ra Ine
    new Rune(1525,Integer.toHexString(Constant.STATS_ADD_CHAN),Integer.toHexString(Constant.STATS_REM_CHAN),(byte)1,1f,1f); //Cha
    new Rune(1550,Integer.toHexString(Constant.STATS_ADD_CHAN),Integer.toHexString(Constant.STATS_REM_CHAN),(byte)3,3f,3f); //Pa Cha
    new Rune(1556,Integer.toHexString(Constant.STATS_ADD_CHAN),Integer.toHexString(Constant.STATS_REM_CHAN),(byte)10,10f,10f); //Ra Cha
    new Rune(1524,Integer.toHexString(Constant.STATS_ADD_AGIL),Integer.toHexString(Constant.STATS_REM_AGIL),(byte)1,1f,1f); //Age
    new Rune(1549,Integer.toHexString(Constant.STATS_ADD_AGIL),Integer.toHexString(Constant.STATS_REM_AGIL),(byte)3,3f,3f); //Pa Age
    new Rune(1555,Integer.toHexString(Constant.STATS_ADD_AGIL),Integer.toHexString(Constant.STATS_REM_AGIL),(byte)10,10f,10f); //Ra Age
    ...
    new Rune(7438,Integer.toHexString(Constant.STATS_ADD_PO),Integer.toHexString(Constant.STATS_REM_PO),(byte)1,51f,25f); //Po
    new Rune(7442,Integer.toHexString(Constant.STATS_ADD_SUM),Integer.toHexString(Constant.STATS_REM_SUM),(byte)1,30f,15f); //Sum
    new Rune(7433,Integer.toHexString(Constant.STATS_ADD_CC),Integer.toHexString(Constant.STATS_REM_CC),(byte)1,10f,5f); //Cri
    new Rune(7434,Integer.toHexString(Constant.STATS_ADD_SOIN),Integer.toHexString(Constant.STATS_REM_SOIN),(byte)1,10f,5f); //So

    new Rune(7460,Integer.toHexString(Constant.STATS_ADD_RP_NEU),Integer.toHexString(Constant.STATS_REM_RP_NEU),(byte)1,6f,3f); //Neutral Re Per
    new Rune(7459,Integer.toHexString(Constant.STATS_ADD_RP_TER),Integer.toHexString(Constant.STATS_REM_RP_TER),(byte)1,6f,3f); //Earth Re Per
    new Rune(7457,Integer.toHexString(Constant.STATS_ADD_RP_FEU),Integer.toHexString(Constant.STATS_REM_RP_FEU),(byte)1,6f,3f); //Fire Re Per
    new Rune(7560,Integer.toHexString(Constant.STATS_ADD_RP_EAU),Integer.toHexString(Constant.STATS_REM_RP_EAU),(byte)1,6f,3f); //Water Re Per
    new Rune(7458,Integer.toHexString(Constant.STATS_ADD_RP_AIR),Integer.toHexString(Constant.STATS_ADD_RP_AIR),(byte)1,6f,3f); //Air Re Per
    ...
    new Rune(7435,Integer.toHexString(Constant.STATS_ADD_DOMA),Integer.toHexString(Constant.STATS_REM_DOMA),(byte)1,10f,5f); //Do
    ...
    new Rune(10618,Integer.toHexString(Constant.STATS_ADD_PERDOM),Integer.toHexString(Constant.STATS_REM_PERDOM),(byte)3,6f,3f); //Pa Do Per
    new Rune(10619,Integer.toHexString(Constant.STATS_ADD_PERDOM),Integer.toHexString(Constant.STATS_REM_PERDOM),(byte)10,20f,10f); //Ra Do Per
    new Rune(7437,Integer.toHexString(Constant.STATS_RETDOM),"",(byte)1,10f,5f); //Do Ren
    new Rune(7446,Integer.toHexString(Constant.STATS_TRAPDOM),"",(byte)1,5f,2.5f); //Pi
    new Rune(10613,Integer.toHexString(Constant.STATS_TRAPDOM),"",(byte)3,15f,7.5f); //Pa Pi
    new Rune(7447,Integer.toHexString(Constant.STATS_TRAPPER),"",(byte)1,2f,1f); //Pi Per
    new Rune(10615,Integer.toHexString(Constant.STATS_TRAPPER),"",(byte)3,6f,3f); //Pa Pi Per
    new Rune(10616,Integer.toHexString(Constant.STATS_TRAPPER),"",(byte)10,20f,10f); //Ra Pi Per

    new Rune(7443,Integer.toHexString(Constant.STATS_ADD_PODS),Integer.toHexString(Constant.STATS_REM_PODS),(byte)10,2.5f,2.5f); //Pod
    new Rune(7444,Integer.toHexString(Constant.STATS_ADD_PODS),Integer.toHexString(Constant.STATS_REM_PODS),(byte)30,7.5f,7.5f); //Pa Pod
    new Rune(7445,Integer.toHexString(Constant.STATS_ADD_PODS),Integer.toHexString(Constant.STATS_REM_PODS),(byte)100,25f,25f); //Ra Pod
    ...
    new Rune(7449,Integer.toHexString(Constant.STATS_ADD_INIT),Integer.toHexString(Constant.STATS_REM_INIT),(byte)30,3f,1.5f); //Pa Ini
    new Rune(7450,Integer.toHexString(Constant.STATS_ADD_INIT),Integer.toHexString(Constant.STATS_REM_INIT),(byte)100,10f,5f); //Ra Ini
    new Rune(7451,Integer.toHexString(Constant.STATS_ADD_PROS),Integer.toHexString(Constant.STATS_REM_PROS),(byte)1,3f,2f); //Prospe
    new Rune(10662,Integer.toHexString(Constant.STATS_ADD_PROS),Integer.toHexString(Constant.STATS_REM_PROS),(byte)3,9f,6f); //Pa Prospe
