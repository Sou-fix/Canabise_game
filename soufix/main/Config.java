...
public class Config
{
  ...
  public int maxconnections=16; //connections per ip limit
  ...
  public int rateKamas=1, rateDrop=3, rateHonor=1, rateJob=5, rateFm=1, rateMount=6;
  ...
  public boolean EXOLIMI=false; //ap, mp and ra exo limit
  public int starHour=2; //how many hours for a mob to gain one star
  public int AIDelay=100, AIMovementCellDelay=200, AIMovementFlatDelay=700, craftDelay=400, gameActionDelay=5; //delay in ms
  ...
  public int averagePingUpdate=1000*60*3; //10 minutes
  public int moveEntityUpdate=1000*60*3; //3 minutes
  public int mountUpdate=1000*60*1; //1 minutes
  public int worldSaveUpdate=1000*60*30; //3 hours
  public int Worldvote = 1000*60*7; //7 minutes
  public int World_kick_threads = 1000*60*1; //30 seconds
  public int Reboot= 1000*60*40; //40 minutes
  ...
  public String boutique = "25593,25594,25540,25541,25542,25543,10862,25475,25476,25477,25478,25479,25480,25481,25482,25483,25484,25485,25486,9636,9637,9638,9639,9640,9643,9642,17918,17917,24461,24462,24463,24464,24465,24466,684,1575,8012,24467,24470,7520,11464,11465,11466,11467,6716,7415,7518,7519,7522,7524,7704,7705,7706,7707,7708,7709,7710,7711,7712,7713,7714,7892,7911,8000,8151,8153,8155,8211,8561,8677,8693,9594,9617,9619,9620,9623,9624,9785,10106,10107,6978,10865,10866,10802,8071,9582,10229,10228,10231,10234,10233,10237,10238,10239,10240,10241,10247,10252,10248,10257,10259,10242,10606,10244,10246,10253,10255,10260,10249,10230,10236,10262,10250,10251,10254,10261,10235,10245,10256,10266,10258,10267,10264,10263,10278,10265,10268,10270,10269,24471,24472,24473,24474,24475,24476,24477,24478,9544,9545,9546,9547,9548,10125,10126,10127,10133";
