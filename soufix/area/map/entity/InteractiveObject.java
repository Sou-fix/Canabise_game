...
public class InteractiveObject
{
  ...
  public final static Updatable updatable=new Updatable(0)
  {
    ...
    public void update()
    {
      ...
      new ArrayList<>(this.queue).stream().filter(interactiveObject -> interactiveObject.getTemplate()!=null&&time-interactiveObject.lastTime>interactiveObject.getTemplate().getRespawnTime()).forEach(interactiveObject -> {
