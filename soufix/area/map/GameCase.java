  ...
  public void startAction(final Player player, GameAction GA)
  {
    ...
    switch(actionID)
    {
      ...
      case 84://Rentrer dans une maison
        ...
        if(mapHouse==null)
        {
          SocketManager.GAME_SEND_MESSAGE(player,"Cette maison ne fonctionne pas. Veuillez envoyer un message de rapport de bogue sur Discord.");
          return;
        }
      ...
      case 170:// Livre des artisans
        ...
        SocketManager.GAME_SEND_ECK_PACKET(player,14,"2;2;11;13;14;15;16;17;18;19;20;24;25;26;27;28;31;33;36;41;43;44;45;46;47;48;49;50;56;58;62;63;64;65");
        break;
      case 181:
